...
const OrderReceivedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === 'development'
      ? 'http://localhost:3000'
      : 'https://casecobra-phonecase.vercel.app';
        ...
        <Container style={container}>
          <Section style={message}>
            <Img
              ...
              style={{ margin: 'auto' }}
            />
            <Heading style={global.heading}>Thank you for choosing us!</Heading>
            <Text style={global.text}>
              We're preparing everything for delivery and will notify you once
              your package has been shipped. Delivery usually takes 2 working
              days.
            </Text>
